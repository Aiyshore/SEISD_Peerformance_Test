...
<html lang="en">
  ...
  <?php
          if(isset($_POST['search'])){
            $on=$_POST['bookdata'];
            $query = "SELECT * FROM t_book WHERE name= '$on' or pbdate='$on' or isbn='$on'";
...
if(isset($_POST['signup'])){
	...
	$inst="INSERT INTO t_user(name,email,mobile,address,street,city,age,pass) VALUES('$name','$email','$mobile','$address','$str','$city','$age','$pass')"; 
